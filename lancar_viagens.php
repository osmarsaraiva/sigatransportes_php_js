...
<head>
  <title>Lançar Viagens Frotas</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form class="form-inline my-2 my-lg-0 mr-5">
      <input name="txtpesquisarFrota" id="txtpesquisarFrota" class="form-control mr-sm-2" type="search" placeholder="Buscar por Frota" aria-label="Pesquisar">
      <button name="buttonPesquisarFrota" class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
    </form>

    <form class="form-inline my-2 my-lg-0 mr-5">
      <input name="txtcrtc"  id="txtcrtc" class="form-control mr-sm-2" type="search" placeholder="Pesquisar por CRTC" aria-label="Pesquisar">
      <button name="buttonPesquisarCRTC" class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
    </form>
  </div>
</nav>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
        <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#modalExemplo">Acertar Viagem</button>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Acertar Viagens/h4>
            </div>
            <div class="card-body">
